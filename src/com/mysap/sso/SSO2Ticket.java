 ...
 * 
 * SAP AG DISCLAIMS ALL WARRANTIES WITH REGARD TO THIS SOFTWARE, INCLUDING ALL
 * IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS, IN NO EVENT SHALL SAP AG
 * BE LIABLE FOR ANY SPECIAL, INDIRECT OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES
 * WHATSOEVER RESULTING FROM LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION
 * OF CONTRACT, NEGLIGENCE OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN
 * CONNECTION WITH THE USE OR PERFORMANCE OF THIS SOFTWARE.
 * 
 * This class provides wrapper functionality for SSO2Ticket (SAP Logon Ticket)
 * in Java.
 * 
 * @version 1.5 2005
 * 
...
public class SSO2Ticket {
	private static final Logger LOG = Logger.getLogger(SSO2Ticket.class);
	 ...
	 * 
	 * @return Object array with: [0] = (String)user, [1] = (String)sysid, [2] =
	 *         (String)client , [3] = (byte[])certificate [4] =
	 *         (String)portalUser, [5] = (String)authSchema, [6] = validity
	 * 
	 */
	 ...
	 * 
	 * @param cert
	 *            Certificate received from evalLogonTicket
	 * @param info_id
	 *            One of the requst id´s
	 * 
	 * @return Info string from certificate
	 * 
	 */
	public static native synchronized String parseCertificate(byte[] cert,
			int info_id);
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			// evaluate the ticket
			Object o[] = evalLogonTicket(ticket, pab != null ? pab
					: "SAPdefault", pwd);
			...
			if (o[3] != null && o[3] instanceof byte[]) {
				...
				/*
				 * remark: The "certificate" object is a DER encoded X.509
				 * certificate of the issuing system, which can be
				 * parsed/analysed with JAVA funtionality e.g. Java Cryptography
				 * Architecture API, IAIK and so on.
				 */
			}// or

			// print out all parameters received from SAPSSOEXT
			PrintResults((String) o[0], (String) o[1], (String) o[2],
					parseCertificate((byte[]) o[3], ISSUER_CERT_SUBJECT),
					parseCertificate((byte[]) o[3], ISSUER_CERT_ISSUER),
					ticket, (String) o[4], (String) o[5], (String) o[6]);
	...
	static void PrintResults(String user, String sysid, String client,
			String subject, String issuer, String ticket, String prtUsr,
			String authS, String validity) {
		System.out.println("***********************************************");
	...
	static void PrintHelp() {
		System.out
				.println("   java SSO2Ticket -i <ticket_file> [-L <SSF_LIB>]");
		System.out
				.println("   [-p <file containing public key>] [-pwd <PSE password>]");
	}
